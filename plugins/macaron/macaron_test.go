...
func TestChildSpanNames(t *testing.T) {
	...
	assert.Equal(t, otelcore.String("/user/123"), span.Attributes["http.route"]) // TODO: span name should show router template, eg /user/:id
	...
	assert.Equal(t, otelcore.String("/book/foo"), span.Attributes["http.route"]) // TODO: span name should show router template, eg /book/:title
}
