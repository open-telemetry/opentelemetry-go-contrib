...
- The The high cardinality attributes `net.sock.peer.*` and `net.peer.*` were removed from the metrics generated by `go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc`. (#????)
