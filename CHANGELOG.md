...
- Added `metricAttributesFn` to `go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp` to allow setting dynamic, per-request metric attributes for http server metrics. (#6541)
