...
- The deprecated `DefaultAttributeSetter` in `go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-sdk-go-v2/otelaws/attributes.go`, use `DefaultAttributeBuilder` function instead. (#7101)
