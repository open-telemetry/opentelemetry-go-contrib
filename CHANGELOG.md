...
- Record `error.type` attribute on server spans in `go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp` when a request is cancelled or ends in a 5xx error. (#TBD)
