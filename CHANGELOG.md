...
- `ParseYAML` in `go.opentelemetry.io/contrib/otelconf` now supports environment variables substitution in the format `${VAR_NAME}`, `${env:VAR_NAME}`, and `${VAR_NAME:-defaultvalue}`. (#6215)
