...
- New runtime metrics are now emitted by default. Deprecated metrics are emitted when the env var `OTEL_GO_X_DEPRECATED_RUNTIME_METRICS` is set to `true`. (#7418)
