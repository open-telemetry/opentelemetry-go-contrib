...
- Add option `WithAttributesOn` to enable `jaeger.sampler.type`/`jaeger.sampler.param` attributes for adaptive sampling support in `go.opentelemetry.io/contrib/samplers/jaegerremote`. (#8073)
