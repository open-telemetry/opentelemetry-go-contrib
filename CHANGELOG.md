...
- Breaking change: otelecho middleware in `go.opentelemetry.io/contrib/instrumentation/github.com/labstack/echo/otelecho` doesn't call error handler anymore. (#4420)
