...
- Added support for providing `endpoint`, `pollingIntervalMs` and `initialSamplingRate` using environment variable `OTEL_TRACES_SAMPLER_ARG` for in `go.opentelemetry.io/contrib/samples/jaegerremote`. (#6310)
