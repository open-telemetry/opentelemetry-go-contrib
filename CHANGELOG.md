...
- The example for the `go.opentelemetry.io/contrib/instrumentation/github.com/gorilla/mux/otelmux` package is moved to be documented in the package itself. (#7121)
