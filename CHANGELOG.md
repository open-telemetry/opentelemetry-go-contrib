...
## [Unreleased]
- Add `WithMetricAttributes` option to `go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp` to allow adding custom attributes to `net/http` metrics.
