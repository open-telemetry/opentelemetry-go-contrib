...
var v04OpenTelemetryConfig = OpenTelemetryConfiguration{
	Disabled:   ptr(false),
	FileFormat: "0.4",
	...
	Resource: &ResourceJson{
		Attributes: []AttributeNameValue{
			...
			{Name: "string_array_key", Type: &AttributeType{Value: "string_array"}, Value: []interface{}{"value1", "value2"}},
			{Name: "bool_array_key", Type: &AttributeType{Value: "bool_array"}, Value: []interface{}{true, false}},
			{Name: "int_array_key", Type: &AttributeType{Value: "int_array"}, Value: []interface{}{1, 2}},
			{Name: "double_array_key", Type: &AttributeType{Value: "double_array"}, Value: []interface{}{1.1, 2.2}},
		},
...
func TestParseYAML(t *testing.T) {
  ...
  line 408: cannot unmarshal !!map into []otelconf.AttributeNameValue`),
		...
		{
			name:     "valid v0.4 config",
			input:    "v0.4.yaml",
			wantType: &v04OpenTelemetryConfig,
		},
	}
