...
func TestUnmarshalResourceJson(t *testing.T) {
	for _, tt := range []struct {
	...
	}{
		{
			...
			jsonConfig: []byte(`{"detection/development": {"detectors": [{"gcp": null},{"aws.eks": null},{"container": null},{"host": null},{"process": null},{"service": null}]}}`),
		...
		},
		{
			...
			jsonConfig: []byte(`{"detection/development": {"detectors": [{"gcp": {}},{"aws.eks": {}},{"container": {}},{"host": {}},{"process": {}},{"service": {}}]}}`),
			yamlConfig: []byte("detection/development:\n  detectors:\n    - gcp: {}\n    - aws.eks: {}\n    - container: {}\n    - host: {}\n    - process: {}\n    - service: {}"),
			wantResource: Resource{
				DetectionDevelopment: &ExperimentalResourceDetection{
					Detectors: []ExperimentalResourceDetector{
