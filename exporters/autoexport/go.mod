...
require (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.43.1-0.20260521080857-e5bdc311108b
...
require (
	...
	go.opentelemetry.io/otel/log v0.19.1-0.20260521080857-e5bdc311108b // indirect
