...
func TestInsertOrUpdateTraceStateThKeyValue(t *testing.T) {
	testCases := []struct {
		...
		{"no th in existing adds th at front", "rv:0123456789abcd;other:value", "th:fedcba987654321", "th:fedcba987654321;rv:0123456789abcd;other:value"},
		{"existing th is replaced", "rv:0123456789abcd;th:0ad;other:value", "th:0e1", "th:0e1;rv:0123456789abcd;other:value"},
