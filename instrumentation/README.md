...
- All instrumentation packages MUST define `ScopeName` constant with a value matching the instrumentation package and use it when creating `Tracer` or `Meter`.
