...
replace (
	...
	go.opentelemetry.io/contrib/instrumentation/github.com/aws/aws-sdk-go-v2/otelaws v0.18.0 => ../
	go.opentelemetry.io/contrib/propagators/aws v0.18.0 => ../../../../../../propagators/aws
)
