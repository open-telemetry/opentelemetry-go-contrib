...
import (
	...
	// import to call ForceFlush method of batch_span_processor.go
	//https://github.com/open-telemetry/opentelemetry-go/blob/main/sdk/trace/batch_span_processor.go#L167
