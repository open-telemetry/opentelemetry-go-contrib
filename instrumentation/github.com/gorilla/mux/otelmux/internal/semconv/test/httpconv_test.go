...
func TestRequestErrorType(t *testing.T) {
	testcases := []struct {
		...
		{err: customError{}, want: attribute.String("error.type", "go.opentelemetry.io/contrib/instrumentation/github.com/gorilla/mux/otelmux/internal/semconv/test.customError")},
	}
