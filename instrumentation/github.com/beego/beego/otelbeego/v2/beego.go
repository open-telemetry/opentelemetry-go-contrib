...
func (o *Handler) ServeHTTP(rr http.ResponseWriter, req *http.Request) {
	...
	defer web.BeeApp.Handlers.GiveBackContext(ctx)
	ctx.Reset(rr, req)
	// use the beego context to try to find a route template
	if router, found := web.BeeApp.Handlers.FindRouter(ctx); found {
...
func NewOTelBeegoMiddleWare(service string, options ...Option) web.MiddleWare {
...
// Render traces web.Controller.Render. Use this function
...
func Render(c *web.Controller) error {
...
// RenderString traces web.Controller.RenderString. Use this function
// if you want to add a child span for the rendering of a template file to
// its string representation.
// Disable autorender before use, and call this function explicitly.
func RenderString(c *web.Controller) (string, error) {
...
// RenderBytes traces web.Controller.RenderBytes. Use this function if
// you want to add a child span for the rendering of a template file to its
// byte representation.
// Disable autorender before use, and call this function explicitly.
func RenderBytes(c *web.Controller) ([]byte, error) {
...
func span(c *web.Controller, spanName string) (context.Context, trace.Span) {
