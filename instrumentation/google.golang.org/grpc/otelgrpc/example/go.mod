...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/example v0.11.0
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.11.0
