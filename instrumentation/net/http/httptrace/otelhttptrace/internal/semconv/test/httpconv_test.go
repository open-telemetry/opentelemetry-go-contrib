...
func TestRequestErrorType(t *testing.T) {
	testcases := []struct {
		...
		{err: customError{}, want: attribute.String("error.type", "go.opentelemetry.io/contrib/instrumentation/net/http/httptrace/otelhttptrace/internal/semconv/test.customError")},
	}
