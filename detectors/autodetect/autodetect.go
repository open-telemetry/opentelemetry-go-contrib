...
var (
	...
	// details).
	IDK8sAPI = ID("k8sapi")
	// IDOracleCloud is the ID for the Oracle Cloud detector that detects
	// resource attributes on Oracle Cloud Infrastructure instances (see
	// oraclecloud.NewResourceDetector for details).
